...
CUSTOMCONNSTR_BLOB_STORAGE_CONNECTION_STRING=os.environ.get("CUSTOMCONNSTR_BLOB_STORAGE_CONNECTION_STRING")
...
if CUSTOMCONNSTR_COSMOS_DB_CONNECTION_STRING == None:
...
if CUSTOMCONNSTR_BLOB_STORAGE_CONNECTION_STRING == None:
    print("CUSTOMCONNSTR_BLOB_STORAGE_CONNECTION_STRING is not set")
    env_vars_set = False
