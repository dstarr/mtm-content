...
def print_env_vars():
    ...
    print(f"COSMOS_DB_CONTENT_COLLECTION_NAME: {COSMOS_DB_CONTENT_COLLECTION_NAME}")
    print(f"COSMOS_DB_METADATA_COLLECTION_NAME: {COSMOS_DB_METADATA_COLLECTION_NAME}")
    print(f"BLOB_STORAGE_CONNECTION_STRING: {BLOB_STORAGE_CONNECTION_STRING}")
    print(f"BLOB_STORAGE_NAME: {BLOB_STORAGE_NAME}")
    print(f"BLOB_STORAGE_CONTAINER_NAME_SLIDES: {BLOB_STORAGE_CONTAINER_NAME_SLIDES}")
    print(f"BLOB_STORAGE_CONTAINER_NAME_PDFS: {BLOB_STORAGE_CONTAINER_NAME_PDFS}")
    print(f"BLOB_STORAGE_CONTAINER_NAME_VIDEO: {BLOB_STORAGE_CONTAINER_NAME_VIDEO}")
    print(f"BLOB_STORAGE_CONTAINER_NAME_TRANSCRIPTS: {BLOB_STORAGE_CONTAINER_NAME_TRANSCRIPTS}")
    print(f"BLOB_STORAGE_CONTAINER_NAME_OTHER: {BLOB_STORAGE_CONTAINER_NAME_OTHER}")
    print(f"BLOB_STORAGE_CONTAINER_NAME_SAMPLE_CODE: {BLOB_STORAGE_CONTAINER_NAME_SAMPLE_CODE}")
